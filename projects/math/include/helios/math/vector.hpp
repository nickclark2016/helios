...
namespace helios
{
    ...
    HELIOS_NO_DISCARD Vector2f operator+(const Vector2f lhs, const Vector2f& rhs);
    HELIOS_NO_DISCARD Vector2f operator-(const f32 lhs, const Vector2f& rhs);
    HELIOS_NO_DISCARD Vector2f operator-(const Vector2f lhs, const f32 rhs);
    HELIOS_NO_DISCARD Vector2f operator-(const Vector2f lhs, const Vector2f& rhs);
    HELIOS_NO_DISCARD Vector2f operator*(const f32 lhs, const Vector2f& rhs);
    ...
    HELIOS_NO_DISCARD f32 angle(const Vector2f& lhs, const Vector2f& rhs) noexcept;
    HELIOS_NO_DISCARD f32 dot(const Vector2f& lhs, const Vector2f& rhs) noexcept;
    ...
    HELIOS_NO_DISCARD Vector2f reflect(const Vector2f vec, const Vector2f& line) noexcept;
    ...
    HELIOS_NO_DISCARD Vector3f operator+(const Vector3f lhs, const Vector3f& rhs);
    HELIOS_NO_DISCARD Vector3f operator-(const f32 lhs, const Vector3f& rhs);
    HELIOS_NO_DISCARD Vector3f operator-(const Vector3f lhs, const f32 rhs);
    HELIOS_NO_DISCARD Vector3f operator-(const Vector3f lhs, const Vector3f& rhs);
    HELIOS_NO_DISCARD Vector3f operator*(const f32 lhs, const Vector3f& rhs);
    ...
    HELIOS_NO_DISCARD f32 angle(const Vector3f& lhs, const Vector3f& rhs) noexcept;
    HELIOS_NO_DISCARD Vector3f cross(const Vector3f lhs, const Vector3f& rhs) noexcept;
    HELIOS_NO_DISCARD f32 dot(const Vector3f& lhs, const Vector3f& rhs) noexcept;
    ...
    HELIOS_NO_DISCARD Vector3f reflect(const Vector3f vec, const Vector3f& line) noexcept;
    ...
    struct alignas(16) Vector4f
    {
        ...
        constexpr Vector4f(const f32 x, const f32 y, const f32 z, const f32 w) noexcept;
        constexpr Vector4f(const Vector2f& xy, const f32 z = 0.0f, const f32 w = 0.0f);
        ...
        constexpr Vector4f(Vector2f&& xy, const f32 z = 0.0f, const f32 w = 0.0f);
    ...
    HELIOS_NO_DISCARD Vector4f operator+(const Vector4f lhs, const Vector4f& rhs);
    HELIOS_NO_DISCARD Vector4f operator-(const f32 lhs, const Vector4f& rhs);
    HELIOS_NO_DISCARD Vector4f operator-(const Vector4f lhs, const f32 rhs);
    HELIOS_NO_DISCARD Vector4f operator-(const Vector4f lhs, const Vector4f& rhs);
    HELIOS_NO_DISCARD Vector4f operator*(const f32 lhs, const Vector4f& rhs);
    ...
    HELIOS_NO_DISCARD f32 angle(const Vector4f& lhs, const Vector4f& rhs) noexcept;
    HELIOS_NO_DISCARD f32 dot(const Vector4f& lhs, const Vector4f& rhs) noexcept;
    ...
    HELIOS_NO_DISCARD Vector4f reflect(const Vector4f vec, const Vector4f& line) noexcept;

    constexpr Vector2f::Vector2f() noexcept : Vector2f(0.0f){};

    constexpr Vector2f::Vector2f(const f32 scalar) noexcept : Vector2f(scalar, scalar)
    {
    }
    ...
    constexpr Vector2f::Vector2f(const Vector2f& other) noexcept : Vector2f(other.x, other.y)
    {
    }

    constexpr Vector2f::Vector2f(Vector2f&& other) noexcept : Vector2f(helios::move(other.x), helios::move(other.y))
    {
    }
    ...
    constexpr Vector2fView::Vector2fView(const Vector2f& vector) noexcept : data()
    {
    ...
    constexpr Vector2fView::Vector2fView(const Vector2fView& vector) noexcept : data()
    {
        data[0] = vector.data[0];
        data[1] = vector.data[1];
    }

    constexpr Vector2fView::Vector2fView(Vector2fView&& vector) noexcept : data()
    {
        data[0] = helios::move(vector.data[0]);
        data[1] = helios::move(vector.data[1]);
    }

    constexpr Vector2fView& Vector2fView::operator=(const Vector2f& rhs) noexcept
    {
        data[0] = rhs.data[0];
        data[1] = rhs.data[1];
        return *this;
    ...
    constexpr Vector2fView& Vector2fView::operator=(const Vector2fView& rhs) noexcept
    {
        data[0] = rhs.data[0];
        data[1] = rhs.data[1];
        return *this;
    ...
    constexpr Vector3f::Vector3f(const f32 scalar) noexcept : Vector3f(scalar, scalar, scalar)
    {
    }

    constexpr Vector3f::Vector3f(const f32 x, const f32 y, const f32 z) noexcept : data()
    {
        data[0] = x;
        data[1] = y;
        data[2] = z;
    ...
    constexpr Vector3f::Vector3f(const Vector2f& xy, const f32 z) : Vector3f(xy.data[0], xy.data[1], z)
    {
    }

    constexpr Vector3f::Vector3f(const Vector3f& other) noexcept : Vector3f(other.data[0], other.data[1], other.data[2])
    {
    }
    ...
    constexpr Vector3f::Vector3f(Vector3f&& other) noexcept
        : Vector3f(helios::move(other.data[0]), helios::move(other.data[1]), helios::move(other.data[2]))
    {
    }
    ...
    {
        return Vector3f(helios::abs(data[0]), helios::abs(data[1]), helios::abs(data[2]));
    }
    ...
    constexpr Vector3fView::Vector3fView(const Vector3f& vector) noexcept : data()
    {
        data[0] = vector.data[0];
        data[1] = vector.data[1];
    ...
    constexpr Vector3fView::Vector3fView(const Vector3fView& vector) noexcept : data()
    {
        data[0] = vector.data[0];
        data[1] = vector.data[1];
        data[2] = vector.data[2];
    ...
    constexpr Vector3fView::Vector3fView(Vector3fView&& vector) noexcept : data()
    {
        data[0] = helios::move(vector.data[0]);
        data[1] = helios::move(vector.data[1]);
        data[2] = helios::move(vector.data[2]);
    ...
    constexpr Vector3fView& Vector3fView::operator=(const Vector3f& rhs) noexcept
    {
        data[0] = rhs.data[0];
        data[1] = rhs.data[1];
        data[2] = rhs.data[2];
    ...
    constexpr Vector3fView& Vector3fView::operator=(const Vector3fView& rhs) noexcept
    {
        data[0] = rhs.data[0];
        data[1] = rhs.data[1];
        data[2] = rhs.data[2];
    ...
    constexpr Vector4f::Vector4f(const f32 scalar) noexcept : Vector4f(scalar, scalar, scalar, scalar)
    {
    }

    constexpr Vector4f::Vector4f(const f32 x, const f32 y, const f32 z, const f32 w) noexcept : data()
    {
        data[0] = x;
        data[1] = y;
        data[2] = z;
    ...
    constexpr Vector4f::Vector4f(const Vector2f& xy, const f32 z, const f32 w) : Vector4f(xy.x, xy.y, z, w)
    {
    }

    constexpr Vector4f::Vector4f(const Vector2f& xy, const Vector2f& zw) : Vector4f(xy.x, xy.y, zw.x, zw.y)
    {
    }

    constexpr Vector4f::Vector4f(const Vector3f& xyz, const f32 w) : Vector4f(xyz.x, xyz.y, xyz.z, w)
    {
    }

    constexpr Vector4f::Vector4f(const Vector4f& other) noexcept : Vector4f(other.x, other.y, other.z, other.w)
    {
    }

    constexpr Vector4f::Vector4f(const Vector4fView& other) noexcept : Vector4f(other.x, other.y, other.z, other.w)
    {
    }

    constexpr Vector4f::Vector4f(Vector2f&& xy, Vector2f&& zw)
        : Vector4f(helios::move(xy.x), helios::move(xy.y), helios::move(zw.x), helios::move(zw.y))
    {
    }
    ...
    constexpr Vector4f::Vector4f(Vector3f&& xyz, const f32 w)
        : Vector4f(helios::move(xyz.x), helios::move(xyz.y), helios::move(xyz.z), w)
    {
    }

    constexpr Vector4f::Vector4f(Vector4f&& other) noexcept
        : Vector4f(helios::move(other.x), helios::move(other.y), helios::move(other.z), helios::move(other.w))
    {
    }
    ...
    {
        return Vector4f(helios::abs(data[0]), helios::abs(data[1]), helios::abs(data[2]), helios::abs(data[3]));
    }
    ...
    constexpr Vector4fView::Vector4fView(const Vector4f& vector) noexcept : data()
    {
        data[0] = vector.data[0];
        data[1] = vector.data[1];
        data[2] = vector.data[2];
    ...
    constexpr Vector4fView::Vector4fView(const Vector4fView& vector) noexcept : data()
    {
        data[0] = vector.data[0];
        data[1] = vector.data[1];
        data[2] = vector.data[2];
    ...
    constexpr Vector4fView::Vector4fView(Vector4fView&& vector) noexcept : data()
    {
        data[0] = helios::move(vector.data[0]);
        data[1] = helios::move(vector.data[1]);
        data[2] = helios::move(vector.data[2]);
    ...
    constexpr Vector4fView& Vector4fView::operator=(const Vector4f& rhs) noexcept
    {
        data[0] = rhs.data[0];
        data[1] = rhs.data[1];
        data[2] = rhs.data[2];
    ...
    constexpr Vector4fView& Vector4fView::operator=(const Vector4fView& rhs) noexcept
    {
        data[0] = rhs.data[0];
        data[1] = rhs.data[1];
        data[2] = rhs.data[2];
