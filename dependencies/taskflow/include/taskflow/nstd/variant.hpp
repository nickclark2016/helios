            ...
            inline namespace cpp17
            {
                ...
                namespace detail
                {
                    ...
                    inline constexpr auto invoke(R T::*f, Arg&& arg, Args&&... args) TF_RETURN(
                        Invoke<std::is_function<R>::value, (std::is_base_of<T, lib::decay_t<Arg>>::value
                                                                ? 0
...
#define TF_VARIANT_SWITCH_VISIT
                ...
                struct base
                {
                    ...
                    struct dispatcher<true, R, ITs...>
                    {
                        ...
                        TF_ALWAYS_INLINE static constexpr R dispatch(F&& f, typename ITs::type&&... visited_vs, V&& v,
                                                                     Vs&&... vs)
                        {
...
#undef TF_DISPATCH
                        ...
                        TF_ALWAYS_INLINE static constexpr R dispatch_case(F&& f, Vs&&... vs)
                        {
                            ...
                            using Actual = decltype(
                                lib::invoke(lib::forward<F>(f), access::base::get_alt<I>(lib::forward<Vs>(vs))...));
                            return visit_return_type_check<Expected, Actual>::invoke(
...
#undef TF_DISPATCH_AT
                    ...
                    struct make_fmatrix_impl
                    {
                        ...
                        inline static constexpr dispatch_result_t<F, Vs...> dispatch(F&& f, Vs&&... vs)
                        {
                            ...
                            using Actual = decltype(
                                lib::invoke(lib::forward<F>(f), access::base::get_alt<Is>(lib::forward<Vs>(vs))...));
                            return visit_return_type_check<Expected, Actual>::invoke(
                ...
                struct alt
                {
                    ...
                    inline static constexpr DECLTYPE_AUTO visit_alt(Visitor&& visitor, Vs&&... vs)
                        ...
                        DECLTYPE_AUTO_RETURN(
                            base::dispatcher<
                                true, base::dispatch_result_t<Visitor, decltype(as_base(lib::forward<Vs>(vs)))...>>::
...
#else
                        DECLTYPE_AUTO_RETURN(
                            base::at(base::make_fmatrix<Visitor&&, decltype(as_base(lib::forward<Vs>(vs)))...>(),
                                     vs.index()...)(lib::forward<Visitor>(visitor), as_base(lib::forward<Vs>(vs))...))
#endif
...
#define TF_VARIANT_DESTRUCTOR(destructible_trait, definition, destroy)                                                 \
    ...
    protected:                                                                                                         \
        destroy                                                                                                        \
            ...
            TF_VARIANT_DESTRUCTOR(Trait::Unavailable, ~destructor() = delete;
...
#define TF_VARIANT_MOVE_CONSTRUCTOR(move_constructible_trait, definition)                                              \
    ...
    public:                                                                                                            \
        ...
        move_constructor& operator=(move_constructor&&) = default;                                                     \
            ...
            TF_VARIANT_MOVE_CONSTRUCTOR(Trait::TriviallyAvailable,
...
#define TF_VARIANT_COPY_CONSTRUCTOR(copy_constructible_trait, definition)                                              \
    ...
    public:                                                                                                            \
        ...
        copy_constructor& operator=(copy_constructor&&) = default;                                                     \
            ...
            TF_VARIANT_COPY_CONSTRUCTOR(Trait::TriviallyAvailable,
...
#define TF_VARIANT_MOVE_ASSIGNMENT(move_assignable_trait, definition)                                                  \
    ...
    public:                                                                                                            \
        ...
        definition                                                                                                     \
            ...
            TF_VARIANT_MOVE_ASSIGNMENT(Trait::TriviallyAvailable,
...
#define TF_VARIANT_COPY_ASSIGNMENT(copy_assignable_trait, definition)                                                  \
    ...
    public:                                                                                                            \
        ...
        definition copy_assignment& operator=(copy_assignment&&) = default;                                            \
            ...
            TF_VARIANT_COPY_ASSIGNMENT(Trait::Unavailable,
...
#undef TF_INHERITING_CTOR
        ...
        namespace detail
        {
            ...
            inline constexpr /* auto * */ AUTO generic_get_if(V* v) noexcept
                AUTO_RETURN(v&& holds_alternative<I>(*v) ? lib::addressof(access::variant::get_alt<I>(*v).value)
                                                         : nullptr)
...
namespace std
{
    ...
    template <typename... Ts>
    struct hash<helios::nstd::detail::enabled_type<
        helios::nstd::variant<Ts...>,
        helios::nstd::lib::enable_if_t<helios::nstd::lib::all<
            helios::nstd::detail::hash::is_enabled<helios::nstd::lib::remove_const_t<Ts>>()...>::value>>>
    {
        using argument_type = helios::nstd::variant<Ts...>;
        using result_type = std::size_t;

        inline result_type operator()(const argument_type& v) const
        {
            using helios::nstd::detail::visitation::variant;
            std::size_t result = v.valueless_by_exception()
                                     ? 299792458 // Random value chosen by the universe upon creation
                                     : variant::visit_alt(
#ifdef TF_GENERIC_LAMBDAS
                                           [](const auto& alt) {
                                               using alt_type = helios::nstd::lib::decay_t<decltype(alt)>;
                                               using value_type =
                                                   helios::nstd::lib::remove_const_t<typename alt_type::value_type>;
    ...
    private:
        ...
        struct hasher
        {
            ...
            {
                using alt_type = helios::nstd::lib::decay_t<Alt>;
                using value_type = helios::nstd::lib::remove_const_t<typename alt_type::value_type>;
                return hash<value_type>{}(alt.value);
            }
        };
#endif
    ...
    template <>
    struct hash<helios::nstd::monostate>
    {
        using argument_type = helios::nstd::monostate;
        using result_type = std::size_t;
