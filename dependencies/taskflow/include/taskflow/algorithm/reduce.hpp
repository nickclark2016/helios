...
namespace helios
{
    ...
    {
        return reduce_guided(std::forward<B>(beg), std::forward<E>(end), init, std::forward<O>(bop), 1);
    }
    ...
    Task FlowBuilder::reduce_guided(B&& beg, E&& end, T& init, O&& bop, H&& chunk_size)
    {

        using I = stateful_iterator_t<B, E>;
        using namespace std::string_literals;

        Task task = emplace([b = std::forward<B>(beg), e = std::forward<E>(end), &r = init, o = std::forward<O>(bop),
                             c = std::forward<H>(chunk_size)](Subflow& sf) mutable {
    ...
    template <typename B, typename E, typename T, typename O, typename H>
    Task FlowBuilder::reduce_dynamic(B&& beg, E&& end, T& init, O&& bop, H&& chunk_size)
    {
    ...
    template <typename B, typename E, typename T, typename O, typename H>
    Task FlowBuilder::reduce_static(B&& beg, E&& end, T& init, O&& bop, H&& chunk_size)
    {
    ...
    {
        return transform_reduce_guided(std::forward<B>(beg), std::forward<E>(end), init, std::forward<BOP>(bop),
                                       std::forward<UOP>(uop), 1);
    }
    ...
    Task FlowBuilder::transform_reduce_guided(B&& beg, E&& end, T& init, BOP&& bop, UOP&& uop, H&& chunk_size)
    {
        ...
        Task task =
            emplace([b = std::forward<B>(beg), e = std::forward<E>(end), &r = init, bop = std::forward<BOP>(bop),
                     uop = std::forward<UOP>(uop), c = std::forward<H>(chunk_size)](Subflow& sf) mutable {
                // fetch the iterator values
                I beg = b;
                I end = e;
    ...
    template <typename B, typename E, typename T, typename BOP, typename UOP, typename H>
    Task FlowBuilder::transform_reduce_dynamic(B&& beg, E&& end, T& init, BOP&& bop, UOP&& uop, H&& chunk_size)
    {
    ...
    template <typename B, typename E, typename T, typename BOP, typename UOP, typename H>
    Task FlowBuilder::transform_reduce_static(B&& beg, E&& end, T& init, BOP&& bop, UOP&& uop, H&& chunk_size)
    {
